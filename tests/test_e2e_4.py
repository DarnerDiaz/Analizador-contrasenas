"""End-to-end integration tests for workflow_4."""
...
class TestE2E:
    ...
    def test_full_workflow_scenario_4(self):
        ...
        # Step 2: Load data
        test_file = self.test_data_dir / 'test_input_4.txt'
        test_file.write_text('test data content 4')
        ...
        # Step 5: Save
        output_file = self.test_data_dir / 'output_4.json'
        pipeline.save_result(result, str(output_file))
        assert output_file.exists()
    
    @pytest.mark.asyncio
    async def test_async_workflow_4(self):
    ...
    def test_error_handling_workflow_4(self):
    ...
    def test_data_integrity_4(self):
    ...
    def test_performance_benchmarks_4(self):
    ...
    def test_concurrent_access_4(self):
    ...
    def test_memory_efficiency_4(self):
